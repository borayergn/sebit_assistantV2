...
export default function Profile(){
    ...
    const ChangesSavedAlert = () => {
        ...
        return(
            ...
            sx={{ position:"absolute", zIndex:1,display: 'flex', alignItems: 'center',justifyContent:"center", opacity: 1, width:"15vw",height:"8vh",borderColor:"primary.main"}}
            >
            <Stack direction="row" spacing={1}>
                <CheckIcon  sx={{ color: 'secondary.main', fontSize:30}} />
                <Typography variant="h5" sx={{ color: 'secondary.main' }}>Changes Saved</Typography>
            </Stack>
            </Box>
        )
    }
        ...
        <Grid item xs = {6} md = {8} sx = {{display:'flex',justifyContent:"center"}}>
          ...
          >
            ...
            <Grid container direction={'column'} spacing={6} sx = {{mt:2}}>
                    ...
                    <Grid item xs = {6} md = {2} sx = {{display:"flex",position:"relative",zIndex:1,justifyContent:"center"}}>
                        <ChangesSavedAlert />
                     </Grid>
    ...
    const ActiveStateButton = ({button_name,handleFunc}) => {
        ...
        if (button_name === activeButton){
                return (
                <Button  button_name = {button_name} style = {{textTransform:"none"}} variant='outlined' size = 'small' sx = {{color:'secondary.main',backgroundColor:"#103142",':hover':{bgcolor:"#2B4E5E"}}} onClick={handleFunc}><Typography sx = {{letterSpacing:2}}>{button_name}</Typography></Button>
                )
            }
        else {
            return (
                <Button  style = {{textTransform:"none"}} variant='outlined' size = 'small' sx = {{color:'secondary.main',':hover':{bgcolor:"#2B4E5E"}}} onClick={handleFunc}><Typography sx = {{letterSpacing:2}}>{button_name}</Typography></Button> 
            )
        }
    ...
    const Usage = () => {
     ...
     function FormDialog() {
            ...
            return (
            <Container>
                <Button variant='outlined' onClick = {handleClickOpen} sx = {{color : 'secondary.main', height : 55 , width : 180 , whiteSpace : "nowrap",ml:136}}>
                    ...
                    <DialogTitle sx = {{color:"secondary.main"}}>Create An API Key</DialogTitle>
                    ...
                    <DialogActions>
                        <Button onClick={handleClose} variant = "outlined" sx = {{color:"secondary.main"}}>Cancel</Button>
                        
                        <Button type = "submit"  form = "form-id" variant = "outlined" sx = {{color:"secondary.main"}}>Create</Button>
                    </DialogActions>
                    </form>
    ...
    const CopyToClipboardButton = () => {
        ...
        return (
            <>
            <IconButton onClick={handleClick} variant = "outlined" sx = {{color:"secondary.main" ,display:"flex",justifyContent:"flex-end",mb:1}}><ContentCopyIcon /></IconButton>
            <Snackbar
                open={open}
    ...
    function OriginalKeyPopup() {
        ...
        return (
        <Container>     
                <Dialog open={originalKeyPopupState} onClose={handleClose} disablePortal>
                <DialogTitle variant = "h5"sx = {{color:"secondary.main", display:"flex",justifyContent:"center"}}>Your API Key</DialogTitle>
                ...
                <DialogActions>
                    <Button onClick={handleClose} variant = "outlined" sx = {{color:"secondary.main",display:"flex",justifyContent:"flex-start",mr:55}}>Cancel</Button>
              ...
              <TableBody>
                {userKeys.map((row) => (
                  <StyledTableRow key={row.name}>
                    ...
                    <StyledTableCell align="left">{row.key.split(".")[0]}</StyledTableCell>
                    <StyledTableCell align="right"><IconButton onClick={() => {
                        axios.delete(Config.Endpoints.API_KEYS_URL+"/"+row.id+"/").then((response => {
                            console.log(response.data)
                            setIsKeysUpdated(true)
                        })
    ...
    return(
        <Container >
            ...
            >
                    ...
                    <ListItem sx={{mt:1.5}}>
                        <Grid container spacing={7} >
                            <Grid item xs = {6} md = {6}  sx = {{display:'flex',justifyContent:"flex-end"}}>
                                <ActiveStateButton button_name = "Settings" handleFunc = {handleSettingsClick}/>
                            </Grid>
                            <Grid item xs = {6} md = {6}  sx = {{display:'flex',justifyContent:"flex-start"}}>
                                <ActiveStateButton button_name = "Account" handleFunc = {handleAccountClick}/>
                            </Grid>
                        </Grid>
                    </ListItem>
                </List>
                ...
                <List sx = {{mt:2}}>
                    <ListItem sx = {{display:'flex',justifyContent:"center",mt:2}}>
                        <ActiveStateButton button_name = "Usage" handleFunc={handleUsageClick}/>
                    </ListItem>
                    <ListItem sx = {{display:'flex',justifyContent:"center",mt:2}}>
                        <ActiveStateButton button_name = "API Keys" handleFunc={handleApiKeysClick}/>
                    </ListItem>
                </List>
                <Box>
                    <List sx={{
